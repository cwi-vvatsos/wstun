...
var logger = log4js.getLogger('wstun:client');
...
(function() {
  ...
  module.exports = wst_client = (function() {
    ...
    function wst_client() {
      logger.trace("[SYSTEM] - WS Tunnel Client starting...");
      this.tcpServer = net.createServer();
    }

    wst_client.prototype.start = function(localPort, wsHostUrl, remoteAddr) {

      logger.trace("[SYSTEM] --> client started.");
      ...
      logger.trace("[SYSTEM] --> WS tunnel established. Waiting for incoming connections...");
      ...
      return this.tcpServer.on("connection", (function(_this) {
        ...
        return function(tcpConn) {
          ...
          var url, wsClient;
          logger.trace("[SYSTEM] - New connection...");
          ...
          wsClient.on('connect', function(wsConn) {
            logger.trace("[SYSTEM] --> WS connected.");
